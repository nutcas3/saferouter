...
export function CTA() {
  return (
    <div className="py-24 bg-klaxosaur-blue">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="bg-black-rock rounded-lg p-6 mb-8 max-w-2xl mx-auto border border-white/20">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="border-white text-white px-8 py-6 text-lg font-medium"
